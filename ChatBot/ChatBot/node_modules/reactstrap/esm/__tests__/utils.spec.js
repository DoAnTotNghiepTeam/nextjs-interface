...
describe('Utils', function () {
  ...
  describe('addDefaultProps', function () {
    it('should return an object', function () {
      ...
      expect(Utils.addDefaultProps(defaultProps, props)).toEqual(expect.any(Object));
    });
    it('should return an object with default props', function () {
      var defaultProps = {
        a: 1,
        b: 2,
        c: 3,
