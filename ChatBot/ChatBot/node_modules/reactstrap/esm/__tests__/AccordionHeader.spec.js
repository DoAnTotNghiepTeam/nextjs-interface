...
describe('AccordionHeader', function () {
  it('should render with "accordion-header" class', function () {
    render( /*#__PURE__*/React.createElement(AccordionHeader, {
      targetId: "cool-accordion",
  ...
  it('should render additional classes', function () {
    testForCustomClass(AccordionHeader, {
      targetId: 'cool-accordion'
    });
  });
  it('should render custom tag', function () {
    testForCustomTag(AccordionHeader, {
      targetId: 'cool-accordion'
    });
  });
  it('should be open if open == targetId', function () {
    render( /*#__PURE__*/React.createElement(AccordionContext.Provider, {
      value: {
        open: 'open-accordion'
      }
    }, /*#__PURE__*/React.createElement(AccordionHeader, {
      targetId: "open-accordion"
    }, "Header open"), /*#__PURE__*/React.createElement(AccordionHeader, {
      targetId: "closed-accordion"
    }, "Header close")));
  ...
  it('should toggle collapse if accordion-button is clicked', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var toggle;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return user.click(screen.getByText(/heading/i));
          case 4:
